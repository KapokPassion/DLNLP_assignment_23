...
def main():
    ...
    for epoch in range(100):
        ...
        torch.save(net.state_dict(), "trian_test_RMS_cross_0.001\{}_model_iter_{}_{}_loss_{:.2f}.pkl".format(time.strftime('%y%m%d%H'), epoch, i, loss.item()))  # current is model_4_layer.pkl
        print("epoch:", epoch + 1, "step:", i + 1, "loss:", loss.item())      
